...
def main():
    ...
    parser.add_argument('-t','--template', default="scripts\\QtDemoTest.wxs",help='template wxs path')
    parser.add_argument('-i','--input', default="installed\\bin\\",help='dir you want to package')
    parser.add_argument('-o','--output', default="build\\QtDemoTest.wxs",help='generator wxs filePath')
