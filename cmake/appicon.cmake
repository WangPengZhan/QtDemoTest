function(appicon TARGET_NAME RESOURCE_FILES)
    if(WIN32)
        set(ICON_RESOURCE resource/${PROJECT_NAME}.ico)
        set(RC_FILE ${CMAKE_CURRENT_BINARY_DIR}/${TARGET_NAME}.rc)
        configure_file(${CMAKE_SOURCE_DIR}/cmake/${PROJECT_NAME}.rc.in ${CMAKE_CURRENT_BINARY_DIR}/${TARGET_NAME}.rc)
        set(RESOURCE_FILES ${ICON_RESOURCE} ${TARGET_NAME}.rc PARENT_SCOPE)
    elseif(APPLE)
        set(ICON_FILE resource/${TARGET_NAME}.icns)
        get_filename_component(ICON_FILE_NAME ${ICON_FILE} NAME)
        set_target_properties(${PROJECT_NAME} PROPERTIES
            MACOSX_BUNDLE_BUNDLE_NAME ${PROJECT_NAME}
            MACOSX_BUNDLE_GUI_IDENTIFIER QtDemoTest.app
    ...
    elseif(UNIX AND NOT APPLE)
        ...
        add_custom_command(TARGET ${TARGET_NAME}
            POST_BUILD
                ...
                COMMAND ${CMAKE_COMMAND} -E copy_if_different ${CMAKE_SOURCE_DIR}/resource/${TARGET_NAME}.svg ${ICON_DIR}
        )
    endif()
endfunction()